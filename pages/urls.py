...
from .views import HomePageView, AboutPageView, ContactPageView, ProductIndexView, ProductShowView, ProductCreateView, CreationCompletedView, CartRemoveAllView, CartView, ImageViewFactory, ImageViewNoDI
...
urlpatterns =[
    ...
    path('products/creation',CreationCompletedView.as_view(), name='creation'),
